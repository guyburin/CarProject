		...
		<div class="form-v5-content">
            ...
            <h2 id="bls">Delete DATA</h2>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="_id" placeholder="" value="<?=$id?>">
                    </div>
                </div>
                ...
                <!-- <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="company" placeholder="">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="Model" placeholder="">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="Color" placeholder="">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="Color1" placeholder="">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-sm" id="Color2" placeholder="">
                    </div>
                </div>
        ...
        $(document).ready(function () {
            ...
            form.submit(function (e) { 
                ...
                function deleteStudent(id){
                    ...
                    $.get("http://localhost/SlimCar/index.php/delete/"+id, {},
                        function (data, textStatus, jqXHR) {
